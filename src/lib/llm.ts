...
export async function describeRoleVoice(
  ...
  const prompt =
    "你是影视剧声音指导。为一个角色设计声音，只输出一段中文声音描述，不要解释、不要多余文字。\n" +
    "严格按下面框架输出，六个字段都要填，字段名与值之间用空格，整段用【】包起来：\n" +
    "【性别 女性，年龄 25 岁左右，音调 音色清脆明亮、偏高，语速 匀速，情感 语气活泼开朗、带一点笑意，质感 吐字清晰】\n" +
    "规则：\n" +
    "1) 性别、年龄按角色信息填写；\n" +
    "2) 语速固定填“匀速”，不许随角色变化；\n" +
    "3) 音调、情感、质感结合角色性格、年龄与台词气质来写，贴合角色。\n\n" +
    "角色信息：\n" +
    "名字：" + role.name + "\n" +
    "性别：" + (role.gender || "未知") + "\n" +
    "年龄段：" + (role.age || "未知") + "\n" +
