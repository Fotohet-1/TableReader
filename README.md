...
- 本地 Qwen3 1.7B VoiceDesign：用自然语言描述为角色生成音色，确认性别年龄后进入“声音设计”步骤，AI 生成描述、试听、人工调整
...
Qwen3 模式下，确认角色性别年龄后会先进入“声音设计”：每个角色有一段声音描述，可让 DeepSeek 根据角色台词自动生成（没有 Key 时用规则模板），编辑满意后生成试听，再进入音色与合成。
